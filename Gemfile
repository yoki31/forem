...
gem "ddtrace", "~> 0.54.0" # ddtrace is Datadog’s tracing client for Ruby.
...
group :development, :test do
  ...
  gem "rubocop-performance", "~> 1.19", require: false # A collection of RuboCop cops to check for performance optimizations in Ruby code
